...
export default function Step2BasicInfo({ setValid }: Step2BasicInfoProps) {
    ...
    useEffect(() => {
        ...
        setValid(!!isValid);
    }, [businessName, ownerName, address, detailAddress, phone, images]);
        ...
        <div className="w-full flex-1 bg-white flex flex-col font-suit px-[1.5rem]">
            <div className="w-full max-w-[544px] mx-auto flex flex-col pt-[2rem]">
                ...
                <div className="mb-[2rem]">
                    <div className="text-[1rem] font-semibold leading-[100%] mb-[0.75rem]">
                        업체명
                    </div>
                    <BasicInput
                ...
                <div className="mb-[2rem]">
                    ...
                    <div className="flex w-full gap-[0.5rem] items-center mb-[0.5rem]">
                        ...
                        <AddButton text='주소 검색하기' className="text-white" onClick={() => {setIsModalOpen(true)}} />
                    </div>
                    <BasicInput
                ...
                <div className="mb-[2rem]">
                    <div className="text-[#252525] text-[1rem] font-bold flex items-center leading-[100%]">
                        ...
                        <span className="ml-0 text-[1rem] font-bold text-[#7F7F7F]">/5</span>
                    </div>
                    
                    <div className="text-[#7F7F7F] text-[0.875rem] font-normal leading-[100%] mt-[0.5rem] mb-[1rem]">최소 3개 이상의 사진을 첨부해주세요</div>
                ...
                <div className="fixed inset-0 z-50 bg-black/50 flex justify-center items-center">
                    <ModalLocationSelector
                        ...
                        onSave={(selectedRegion) => {
                            setAddress(selectedRegion.region);
                            // 좌표값 등도 필요하면 저장 가능
