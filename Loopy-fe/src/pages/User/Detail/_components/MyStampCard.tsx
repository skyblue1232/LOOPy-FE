    ...
    return (
        <div className="flex flex-col">
            <div className="flex items-center justify-between">
                <span className="text-[1rem] font-semibold text-[#000000]">내 스탬프</span>
                <button
            ...
            <div className="mt-[1rem] flex items-center gap-[1rem]">
                {/* 숫자 */}
                <div className="min-w-fit flex items-baseline">
                <span className="text-[1.5rem] font-semibold text-[#6970F3]">{current}</span>
                <span className="text-[0.875rem] font-semibold text-[#A8A8A8] ml-[0.25rem]">
                    / {total}
                </span>
                </div>
            ...
            <div className="mt-[0.5rem] flex justify-end">
                <span className="text-[0.875rem] font-normal text-[#6970F3]">
                    스탬프 기한 ~{dueDate}
                </span>
            </div>
        </div>
