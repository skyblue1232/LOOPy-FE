...
export const stampHistoryDummy: StampHistory[] = [
  {
    id: 1,
    cafeName: "카페 위드",
  ...
  {
    id: 5,
    cafeName: "스타벅스 연세백양로점",
    cafeAddress: "서울 서대문구 백양로 50",
